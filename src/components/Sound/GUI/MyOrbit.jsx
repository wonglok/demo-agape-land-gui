...
// MyOrbitControls performs orbiting, dollying (zooming), and panning.
  ...
  constructor(object, domElement) {
    ...
    this.update = (function () {
      ...
      return function update(deltaTime = null) {
        ...
        if (this.myTarget) {
          //
          this.myTarget.rotation.y +=
            sphericalDelta.theta * scope.dampingFactor;
          this.myTarget.rotation.x += sphericalDelta.phi * scope.dampingFactor;
        }
        ...
        if (scope.zoomToCursor && performCursorZoom) {
          ...
          if (scope.object.isPerspectiveCamera) {
            ...
            console.warn(
              "WARNING: MyOrbitControls.js encountered an unknown camera type - zoom to cursor disabled."
            );
    ...
    const pan = (function () {
      ...
      return function pan(deltaX, deltaY) {
        ...
        if (scope.object.isPerspectiveCamera) {
          ...
          console.warn(
            "WARNING: MyOrbitControls.js encountered an unknown camera type - pan disabled."
          );
    ...
    function dollyOut(dollyScale) {
      if (
        ...
        console.warn(
          "WARNING: MyOrbitControls.js encountered an unknown camera type - dolly/zoom disabled."
        );
