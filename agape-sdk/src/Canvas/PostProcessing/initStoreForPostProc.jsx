export const initStoreForPostProc = ({ postProcessingConfig = {} }) => {
  ...
  postProcessingConfig.emissiveIntensity = postProcessingConfig.emissiveIntensity || 0
  postProcessingConfig.envMapIntensity = postProcessingConfig.envMapIntensity || 0
