...
import { AnimationMixer, Box3, Clock, Matrix4, Mesh, MeshStandardMaterial, Object3D, Spherical, Vector3 } from 'three'
...
class AvatarChaserCore extends Object3D {
  ...
  updatePlayer(delta) {
    ...
    this.destination.visible = this.destination.position.distanceTo(this.player.position) >= 1.5
  }
